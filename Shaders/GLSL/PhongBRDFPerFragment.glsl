...
void main(void) {
    ...
    if (mode == 0) finalColour = lambertian * diffuseColour + specular * specularColour;
    else if (mode == 1) finalColour = lambertian * diffuseColour;
    else if (mode == 2) finalColour = specular * specularColour;
