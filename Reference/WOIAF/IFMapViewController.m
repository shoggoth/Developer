...
@interface IFMapViewController ()

@end

@implementation IFMapViewController {
...
- (void)loadMap:(Map *)map {
    ...
    for (MapLocation *mapLocation in map.mapLocations) {
        ...
        if (mapLocation.book.intValue <= [IFCoreDataStore defaultDataStore].lastBookRead) {
            ...
            pin.pos = CGPointMake(mapLocation.x.floatValue * iPadScaleFactor.x, mapLocation.y.floatValue * iPadScaleFactor.y);
