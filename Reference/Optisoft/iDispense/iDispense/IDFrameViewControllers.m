...
#import "IDFrameViewControllers.h"
#import "IDDispensingDataStore.h"

#pragma mark Master

@implementation IDFrameMasterViewController
...
- (UITableViewCell *)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    IDFrameCell *orderCell = (IDFrameCell *)cell;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *cell  = [self.tableView dequeueReusableCellWithIdentifier:@"FrameCell"];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    IDFrameDetailViewController *detailViewController = segue.destinationViewController;
...
@interface IDFrameDetailViewController ()
...
@implementation IDFrameDetailViewController {
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.navigationItem.title = [NSString stringWithFormat:@"Frame %lld", self.detailOrder.guid];
}
