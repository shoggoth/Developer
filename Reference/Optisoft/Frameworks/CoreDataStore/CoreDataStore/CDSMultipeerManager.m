...
NSString *const CDSSyncPeerService = @"iDispense";
NSString *const kDiscoveryInfoUniqueIdentifer = @"DiscoveryInfoUniqueIdentifer";

@interface CDSMultipeerManager () <MCNearbyServiceBrowserDelegate, MCNearbyServiceAdvertiserDelegate, MCSessionDelegate>
{
...
@implementation CDSMultipeerManager
...
- (void)start
{
    ...
    peerAdvertizer = [[MCNearbyServiceAdvertiser alloc] initWithPeer:peerID discoveryInfo:@{kDiscoveryInfoUniqueIdentifer : uniqueIdentifier} serviceType:CDSSyncPeerService];
    peerAdvertizer.delegate = self;
    [peerAdvertizer startAdvertisingPeer];

    peerBrowser = [[MCNearbyServiceBrowser alloc] initWithPeer:peerID serviceType:CDSSyncPeerService];
